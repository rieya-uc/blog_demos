...
function preload() {
    ...
    //game.load.image('ground_1x1', 'assets/daneeklu_tilesets/farming_fishing.png');
...
function create() {
    ...
    layer4Key = game.input.keyboard.addKey(Phaser.Keyboard.FOUR);
    ...
    layer4Key.onDown.add(changeLayer, this);
